...
class FridayList2 extends StatefulWidget {
  const FridayList2({Key? key}) : super(key: key);

  @override
  State<FridayList2> createState() => _FridayList2State();
}


class _FridayList2State extends State<FridayList2> {
  @override
              ...
              children: [
                TimerBuilder.periodic(Duration(seconds: 1), builder: (context){
                  ...
                  return Column(
                    children: [
                      SubjectContainer(
                          subject: 'SCIENCE', classroom: 'TG-201', teacher: 'Amanpreet Kaur',
