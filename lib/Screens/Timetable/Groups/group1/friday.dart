import 'package:community_app/Screens/Timetable/Database/data_g11.dart';
import 'package:community_app/Screens/Timetable/Database/data_g17.dart';
import 'package:community_app/Screens/Timetable/Database/data_g18A.dart';
import 'package:community_app/Screens/Timetable/Database/data_g18B.dart';
import 'package:community_app/Screens/Timetable/Database/data_g5.dart';
...
class FridayList extends StatefulWidget {
  ...
  const FridayList({Key? key, required this.gradeIndex}) : super(key: key);

  @override
  State<FridayList> createState() => _FridayListState();
}
...
class _FridayListState extends State<FridayList> {
  ...
  Widget build(BuildContext context) {
    List<TimetableEntry> data = gradeData[widget.gradeIndex][4];
                  ...
                  return Column(
                    children: [
                      SubjectContainer(
                          ...
                          gradient: (day == 5 && (hour == 9 && min < 45))
                              ? kOrangeGradient
                              : kGreyGradient),

                      SubjectContainer(
                          subject: data[1].subject, classroom: data[1].classroom,
                          gradient: (day == 5 && ((hour == 9 && min >= 45) || (hour == 10 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 5 && ((hour == 10 && min >= 30) || (hour == 11 && min >= 0 && min < 15)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 5 && ((hour == 12 && min >= 45) || (hour == 13 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 5 && ((hour == 13 && min >= 30) || (hour == 14 && min >= 0 && min < 15)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 5 && ((hour == 15 && min >= 45) || (hour == 16 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
