...
class WednesdayList extends StatefulWidget {
  ...
  const WednesdayList({Key? key, required this.gradeIndex}) : super(key: key);

  @override
  State<WednesdayList> createState() => _WednesdayListState();
}
...
class _WednesdayListState extends State<WednesdayList> {
  ...
  Widget build(BuildContext context) {
    List<TimetableEntry> data = gradeData[widget.gradeIndex][2];
                  ...
                  return Column(
                    children: [
                      SubjectContainer(
                          ...
                          gradient: (day == 3 && (hour == 9 && min < 45))
                              ? kOrangeGradient
                              : kGreyGradient),

                      SubjectContainer(
                          subject: data[1].subject, classroom: data[1].classroom,
                          gradient: (day == 3 && ((hour == 9 && min >= 45) || (hour == 10 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 3 && ((hour == 10 && min >= 30) || (hour == 11 && min >= 0 && min < 15)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 3 && ((hour == 12 && min >= 45) || (hour == 13 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 3 && ((hour == 13 && min >= 30) || (hour == 14 && min >= 0 && min < 15)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 3 && ((hour == 15 && min >= 45) || (hour == 16 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
                    ],
                  );
