...
class ThursdayList1 extends StatefulWidget {
  const ThursdayList1({Key? key}) : super(key: key);

  @override
  State<ThursdayList1> createState() => _ThursdayList1State();
}


class _ThursdayList1State extends State<ThursdayList1> {
  @override
