...
class TuesdayList extends StatefulWidget {
  ...
  const TuesdayList({Key? key, required this.gradeIndex}) : super(key: key);

  @override
  State<TuesdayList> createState() => _TuesdayListState();
}
...
class _TuesdayListState extends State<TuesdayList> {
  ...
  Widget build(BuildContext context) {
    List<TimetableEntry> data = gradeData[widget.gradeIndex][1];
                  ...
                  return Column(
                    children: [
                      SubjectContainer(
                          ...
                          gradient: (day == 2 && (hour == 9 && min < 45))
                              ? kOrangeGradient
                              : kGreyGradient),

                      SubjectContainer(
                          subject: data[1].subject, classroom: data[1].classroom,
                          gradient: (day == 2 && ((hour == 9 && min >= 45) || (hour == 10 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 2 && ((hour == 10 && min >= 30) || (hour == 11 && min >= 0 && min < 15)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 2 && ((hour == 12 && min >= 45) || (hour == 13 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 2 && ((hour == 13 && min >= 30) || (hour == 14 && min >= 0 && min < 15)))
                              ? kOrangeGradient
                              : kGreyGradient),
                      ...
                      SubjectContainer(
                          ...
                          gradient: (day == 2 && ((hour == 15 && min >= 45) || (hour == 16 && min >= 0 && min < 30)))
                              ? kOrangeGradient
                              : kGreyGradient),
                    ],
                  );
