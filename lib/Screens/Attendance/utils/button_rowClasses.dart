...
class ButtonRowClasses extends StatefulWidget {
  int num;
  int compare_num;
  ...
  @override
  State<ButtonRowClasses> createState() => _ButtonRowClassesState();
}

class _ButtonRowClassesState extends State<ButtonRowClasses> {
  int minus(int num){
